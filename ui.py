...
class UI:
    ...
    def get_code_text(self) -> str: return "\n".join(self.code_lines)
    def set_exec_line(self, idx: int): self.exec_line = idx
    ...
    def draw(self, screen, game, show_level_msg=False):
        ...
        if show_level_msg:
            ...
            txt = LARGE_FONT.render("+10 ОЧКОВ! НОВЫЙ УРОВЕНЬ!", True, (255, 215, 0))
