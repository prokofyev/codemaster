...
if FONT.get_height() == 0:
    raise RuntimeError("❌ Не удалось инициализировать шрифт с поддержкой кириллицы.")
...
class UI:
    def __init__(self, screen_w, screen_h):
        ...
        self.grid_off_y = max(60, (screen_h - grid_pix) // 2)
    ...
    def draw(self, screen, game):
        ...
        # Цель (синий квадрат)
        tx, ty = game.get_target_pos()
        target_rect = pygame.Rect(self.grid_off_x + tx * self.cell_size + 4,
                                  self.grid_off_y + ty * self.cell_size + 4,
                                  self.cell_size - 8, self.cell_size - 8)
        pygame.draw.rect(screen, (60, 140, 240), target_rect)
        pygame.draw.rect(screen, (255, 255, 255), target_rect, 2)
        ...
        for i, line in enumerate(self.code_lines):
            ...
            bg = (35, 35, 50)
            if i == self.exec_line: bg = (80, 70, 30)
        ...
        if msg:
            ...
            screen.blit(msg_surf, (self.editor_x, self.h - 35))